...
%\centerline{\normalsize{政治面貌：中共预备党员\quad \faEnvelopeO\ \href{mailto:3230100823@zju.edu.cn}{3230100823@zju.edu.cn}}} 
    
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育背景}    
%\textbf{浙江省杭州高级中学} \hfill 2020.09 -- 2023.06\\[0.3em] % 标题和正文间加一点距离
\textbf{浙江大学} \hfill 2023.09 -- 至今\\[0.3em] % 标题和正文间加一点距离
材料科学与工程（卓越人才培养班）\quad 大三

\begin{itemize}[nosep]
    \item \textbf{主修均绩：}4.62 / 5.0\quad \textbf{累计排名：}4 / 103
    \item \textbf{核心专业课程：}《材料物理》95 / 5.0、《材料表征1》95 / 5.0、《材料表征2》93 / 4.8《材料表征3》96 / 5.0\\《材料性能1》96 / 5.0、《材料科学基础1》93 / 4.8、《材料工艺学1》96 / 5.0
\end{itemize}

\section{\makebox[\widthof{\faCogs}][c]{\color{CVBlue}\faCogs}\ 科研经历}
% --- 第一个项目 ---
% 将标题行末尾的 \\ 替换为 \titlebreak 命令
\textbf{项目1：国家级大学生创新训练项目（项目负责人）}\\
\textbf{SAM预组装对刮涂法制备钙钛矿太阳能电池的影响机制研究}\qquad 导师：薛晶晶 教授 \hfill 2025.03 -- 2026.05 \titlebreak
项目简介：通过Py3-SiOx预组装复合体系\textbf{构建体相纳米异质界面}，\textbf{突破}传统自组装小分子的\textbf{有序堆积模式}，大幅增加化学界面以实现SAM层\textbf{牢固锚定}，有效改善纯SAM\textbf{刮涂工艺效率低下}的短板，为高效率、高稳定性钙钛矿太阳能电池的大面积、规模化生产提供重要借鉴。出生年月：2005年2月 政治面貌：中共预备党员

% 使用 \projectsep 命令来分隔两个项目
\projectsep

% --- 第二个项目 ---
\textbf{项目2：材料学院卓越人才培养班《创新实践》课程项目（项目负责人）}\\
\textbf{SAM团簇抑制机制及其对钙钛矿太阳能电池性能的调控}\qquad 导师：薛晶晶 教授 \hfill 2025.05 -- 至今 \titlebreak
项目简介：通过\textbf{调控}Py3-SiOx预组装复合体系中SiOx纳米颗粒的\textbf{粒径和表面配体}，实现对SAM\textbf{团簇}的\textbf{有效抑制}，构建更为均匀、致密的空穴传输层，提升钙钛矿太阳能电池的综合光电性能。
...
\begin{itemize}
%\item 浙江大学云峰学园学生党员骨干基地\quad 组织部干事 \hfill 2023.09 -- 2024.06
    \item 浙江大学云峰学园学生党员骨干基地\quad 负责人 \hfill 2024.09 -- 2025.06
    \item 材料2304班\quad 学习委员 \hfill 2024.09 -- 至今
\end{itemize}
...
\begin{itemize}[parsep=0.5ex]
    ...
    \item \textbf{编程水平：} 掌握C语言的基础知识，具备基本的代码编写与程序设计能力，《C语言程序设计》93 / 4.8
